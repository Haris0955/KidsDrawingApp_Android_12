...
class MainActivity : AppCompatActivity() {
            ...
            permissions.entries.forEach {
                ...
                if (isGranted) {
                    ...
                    if (permissionName == Manifest.permission.READ_EXTERNAL_STORAGE) {
                        Toast.makeText(this, "Oops you denied the permission", Toast.LENGTH_LONG)
                            .show()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val brushImgBtn: ImageButton = findViewById(R.id.ib_brush)
        brushImgBtn.setOnClickListener {
            showBrushSizeChooserDialog()
        }

        val galleryImgBtn: ImageButton = findViewById(R.id.ib_gallery)
        galleryImgBtn.setOnClickListener {
            requestStoragePermission()
        }

        val undoImgBtn: ImageButton = findViewById(R.id.ib_undo)
        undoImgBtn.setOnClickListener {
            // This is for undo recent stroke.
            drawingView?.onClickUndo()
        }

        val redoImgBtn: ImageButton = findViewById(R.id.id_IB_redo)
        redoImgBtn.setOnClickListener {
            drawingView?.onClickRedo()
        }

        val saveImgBtn: ImageButton = findViewById(R.id.ib_save)
    ...
    private fun showBrushSizeChooserDialog() {
        ...
        val smallBtn: ImageButton = brushDialog.findViewById(R.id.id_IB_smallBrush)
        smallBtn.setOnClickListener {
            drawingView?.setSizeForBrush(10.toFloat())
            brushDialog.dismiss()
        }

        val mediumBtn: ImageButton = brushDialog.findViewById(R.id.id_IB_mediumBrush)
        mediumBtn.setOnClickListener(View.OnClickListener {
            drawingView?.setSizeForBrush(20.toFloat())
            brushDialog.dismiss()
        })

        val largeBtn: ImageButton = brushDialog.findViewById(R.id.id_IB_largeBrush)
   ...
   // A function for color selection.
    ...
    private fun shareFile(directory : String){
      ...
      to the client of the MediaScannerConnection class.*/
        ...
        MediaScannerConnection.scanFile(this@MainActivity, arrayOf(directory), null) {
